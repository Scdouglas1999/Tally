#!/bin/bash
# Builds a Tally release into tally/out/: the signed APKs for Android TV and the server plugin (a zip per Jellyfin
# version, Tally-Server-Setup.exe, docker-compose.yml, install-linux.sh, and the plugin repository's manifest.json).
