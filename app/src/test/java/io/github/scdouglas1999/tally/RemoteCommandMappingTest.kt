...
import io.github.scdouglas1999.tally.remote.TallyRemoteBus
import io.github.scdouglas1999.tally.remote.displayContentFor
import io.github.scdouglas1999.tally.remote.keyCodeFor
import io.github.scdouglas1999.tally.remote.trackCommandFor
import io.github.scdouglas1999.tally.remote.volumeIndexFor
...
class RemoteCommandMappingTest {
    ...
    fun `subtitle off from the remote is the player's disabled index`() {
        ...
        assertEquals(
            TallyRemoteBus.TrackCommand.Subtitle(TrackIndex.DISABLED),
            trackCommandFor(GeneralCommandType.SET_SUBTITLE_STREAM_INDEX, mapOf("Index" to "-1")),
        )
        assertEquals(
            TallyRemoteBus.TrackCommand.Subtitle(4),
