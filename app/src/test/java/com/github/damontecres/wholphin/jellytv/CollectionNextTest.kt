...
import com.github.damontecres.wholphin.jellytv.playback.CollectionEntry
import com.github.damontecres.wholphin.jellytv.playback.CollectionNext
        ...
        val items: List<BaseItemDto> by lazy {
            val text =
                CollectionNextTest::class.java
                    .getResource("/jellytv/movies-provider-ids.json")!!
                    .readText()
