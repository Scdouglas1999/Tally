...
import com.github.damontecres.wholphin.jellytv.household.HOUSEHOLD_TICKS_PER_MS
import com.github.damontecres.wholphin.jellytv.household.mapHouseholdSessions
import com.github.damontecres.wholphin.jellytv.ui.household.progressFraction
...
/**
 * Mapping of a captured `GET /Sessions` (`sessions-sample.json`) onto [com.github.damontecres.wholphin.jellytv.household.HouseholdSession].
...
class HouseholdSessionsTest {
    private val sessions: List<SessionInfoDto> by lazy {
        val text =
            javaClass
                .getResource("/jellytv/sessions-sample.json")!!
                .readText()
