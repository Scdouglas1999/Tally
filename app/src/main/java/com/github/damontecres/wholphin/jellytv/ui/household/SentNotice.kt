    ...
    key(notice.id) {
        ...
        LowerThird(
            ...
            Column(
                ...
                Text(
                    text = stringResource(if (notice.sent) R.string.jtv_motion_sent else R.string.jtv_motion_not_sent).uppercase(),
                    style = JtvType.label,
                    color = if (notice.sent) JtvColors.accent else JtvColors.live,
                    maxLines = 1,
                )
                Text(
