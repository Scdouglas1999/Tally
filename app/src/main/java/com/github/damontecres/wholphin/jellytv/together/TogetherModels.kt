 ...
 * other JellyTV TVs) play the same item in step. The server is the referee: members send requests (unpause,
 * pause, seek, "I'm buffering", "I'm ready") and the server answers everyone with timed commands.
 *
 * Observed on Jellyfin 10.10 (see `jellytv/dev/syncplay-peer.py`):
