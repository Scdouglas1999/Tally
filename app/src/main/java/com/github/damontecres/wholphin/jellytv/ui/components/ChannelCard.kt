...
/**
 * A channel card: the channel's 16:9 card image cropped onto a [JtvColors.screen]
...
fun ChannelCard(
    ...
    Surface(
        ...
        modifier = modifier.height(JtvDimens.cardHeight),
    ) {
...
private fun scoreline(game: JtvGame): String =
