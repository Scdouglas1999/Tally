...
/**
 * Server-pushed playback. Decides which player a pushed "play this item" opens. A JellyTV channel opens in the JellyTV player
...
class JellyTvPlayRouter
    ...
    constructor(
        ...
        /**
         * Plays what the server pushes to this session ("Play on TV" from the JellyTV web UI, or any Jellyfin
