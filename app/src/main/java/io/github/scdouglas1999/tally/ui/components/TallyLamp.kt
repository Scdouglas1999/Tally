    ...
    Box(
        modifier
            ...
            .drawBehind {
                    ...
                    drawCircle(
                        brush =
                            Brush.radialGradient(
                                0f to TallyColors.accent.copy(alpha = GLOW_ALPHA * value.glow),
                                1f to TallyColors.accent.copy(alpha = 0f),
                                center = center,
                                radius = radius,
                            ),
                        radius = radius,
                ...
                drawRect(lerp(LAMP_OFF, TallyColors.accent, value.brightness.coerceIn(0f, 1f)))
            },
    )
}
