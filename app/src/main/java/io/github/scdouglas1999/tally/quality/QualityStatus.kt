...
object QualityStatus {
     ...
     * (null) for a live stream: the server's figure for one is not the stream's bitrate (a Tally channel
    ...
    private val REASON_RES: Map<TranscodeReason, Int> =
        mapOf(
            TranscodeReason.CONTAINER_NOT_SUPPORTED to R.string.tally_quality_reason_container,
            TranscodeReason.VIDEO_CODEC_NOT_SUPPORTED to R.string.tally_quality_reason_video_codec,
            TranscodeReason.AUDIO_CODEC_NOT_SUPPORTED to R.string.tally_quality_reason_audio_codec,
            TranscodeReason.SUBTITLE_CODEC_NOT_SUPPORTED to R.string.tally_quality_reason_subtitles,
            TranscodeReason.AUDIO_IS_EXTERNAL to R.string.tally_quality_reason_external_audio,
            TranscodeReason.SECONDARY_AUDIO_NOT_SUPPORTED to R.string.tally_quality_reason_secondary_audio,
            TranscodeReason.VIDEO_PROFILE_NOT_SUPPORTED to R.string.tally_quality_reason_video_profile,
            TranscodeReason.VIDEO_LEVEL_NOT_SUPPORTED to R.string.tally_quality_reason_video_level,
            TranscodeReason.VIDEO_RESOLUTION_NOT_SUPPORTED to R.string.tally_quality_reason_resolution,
            TranscodeReason.VIDEO_BIT_DEPTH_NOT_SUPPORTED to R.string.tally_quality_reason_bit_depth,
            TranscodeReason.VIDEO_FRAMERATE_NOT_SUPPORTED to R.string.tally_quality_reason_framerate,
            TranscodeReason.REF_FRAMES_NOT_SUPPORTED to R.string.tally_quality_reason_ref_frames,
            TranscodeReason.ANAMORPHIC_VIDEO_NOT_SUPPORTED to R.string.tally_quality_reason_anamorphic,
            TranscodeReason.INTERLACED_VIDEO_NOT_SUPPORTED to R.string.tally_quality_reason_interlaced,
            TranscodeReason.AUDIO_CHANNELS_NOT_SUPPORTED to R.string.tally_quality_reason_audio_channels,
            TranscodeReason.AUDIO_PROFILE_NOT_SUPPORTED to R.string.tally_quality_reason_audio_profile,
            TranscodeReason.AUDIO_SAMPLE_RATE_NOT_SUPPORTED to R.string.tally_quality_reason_sample_rate,
            TranscodeReason.AUDIO_BIT_DEPTH_NOT_SUPPORTED to R.string.tally_quality_reason_audio_bit_depth,
            TranscodeReason.CONTAINER_BITRATE_EXCEEDS_LIMIT to R.string.tally_quality_reason_quality_limit,
            TranscodeReason.VIDEO_BITRATE_NOT_SUPPORTED to R.string.tally_quality_reason_video_bitrate,
            TranscodeReason.AUDIO_BITRATE_NOT_SUPPORTED to R.string.tally_quality_reason_audio_bitrate,
            TranscodeReason.UNKNOWN_VIDEO_STREAM_INFO to R.string.tally_quality_reason_unknown_video,
            TranscodeReason.UNKNOWN_AUDIO_STREAM_INFO to R.string.tally_quality_reason_unknown_audio,
            TranscodeReason.DIRECT_PLAY_ERROR to R.string.tally_quality_reason_direct_play,
            TranscodeReason.VIDEO_RANGE_TYPE_NOT_SUPPORTED to R.string.tally_quality_reason_hdr,
            TranscodeReason.VIDEO_CODEC_TAG_NOT_SUPPORTED to R.string.tally_quality_reason_codec_tag,
        )
}
