...
class MultiviewPlayers internal constructor(
    ...
    private val decoderLimitMessage = appContext.getString(R.string.tally_mv_no_decoder)
    private val unavailableMessage = appContext.getString(R.string.tally_mv_unavailable)
