...
/**
 * The Tally look as a Wholphin theme, selected as `AppThemeColors.TALLY` (the fork's default).
 *
 * Same palette as the Tally section and the Tally web UI (see TALLY.md): flat near-black grounds,
 ...
 */
val TallyThemeColors: ThemeColors =
    object : ThemeColors {
        // --- dark: the Tally tokens verbatim ------------------------------------------------------------
