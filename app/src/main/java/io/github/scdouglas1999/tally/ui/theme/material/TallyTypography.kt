...
/**
 * IBM Plex for the whole app when the Tally theme is active, so Wholphin's screens read as the same design
 * as the Tally section: IBM Plex Sans for anything you read, IBM Plex Mono for the instrument-like label
...
/** IBM Plex Mono Medium with the 1sp tracking that the Tally labels use. */
...
val TallyTypography: androidx.tv.material3.Typography =
...
val TallyMaterialTypography: androidx.compose.material3.Typography =
