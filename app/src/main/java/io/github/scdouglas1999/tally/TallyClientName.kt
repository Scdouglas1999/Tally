 ...
 * was called Tally therefore keep reporting "JellyTV" for good, and fresh installs report "Tally".
 *
...
object TallyClientName {
    ...
    fun get(
        ...
        val name = if (isPreRenameInstall(context)) appName.replace("Tally", "JellyTV") else appName
        prefs.edit { putString(KEY_NAME, name) }
        return name
    }

    private fun isPreRenameInstall(context: Context): Boolean {
