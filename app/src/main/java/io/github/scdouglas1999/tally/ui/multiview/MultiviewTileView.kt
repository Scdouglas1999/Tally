...
package io.github.scdouglas1999.tally.ui.multiview
    ...
    Surface(
        ...
        Box(Modifier.fillMaxWidth()) {
                ...
                Box(
                    ...
                    val status =
                        when {
                            ...
                            playback.player == null || playback.buffering -> {
                                stringResource(R.string.tally_mv_buffering)
                            }
                    ...
                    if (status != null) {
                        Text(
                            ...
                            color =
                                if (playback.error != null) TallyColors.liveText else TallyColors.muted,
            ...
            Text(
                text =
                    stringResource(
                        if (hasAudio) R.string.tally_mv_audio else R.string.tally_mv_muted,
                    ).uppercase(),
                style = TallyType.label,
