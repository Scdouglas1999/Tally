...
public class CardController : ControllerBase
{
    ...
    [HttpGet("{key}.png")]
    public async Task<IActionResult> Get(string key, [FromQuery] string? n, CancellationToken cancellationToken)
    {
        ...
        var png = channel != null
            ? await _cards.RenderAsync(channel, cancellationToken).ConfigureAwait(false)
